...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const car = await db.get<CarModel | undefined>(
    ...
    // so instead of getting the details of all cars we are getting the details of a particular car
    id,
  );
  ...
  return {
    props: {
      car: car || null,
      // double pipe operator (||) is the logical OR operator 
      // single pipe means union type describes a value that can be one of several types. 
    },
  };
};
